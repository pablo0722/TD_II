...
# 11 "../FFT/fft_globales.c" 2
 ...
 volatile q31_t fft_in[512];
 volatile q31_t fft_out_cmplx[512*2];
 volatile q31_t fft_out_dep[512];
 volatile q31_t fft_out_rem[512];

 volatile q31_t fft_max_val;
 volatile uint32_t fft_max_index;

 volatile q31_t THD;

 uint8_t volatile fft_status = 0;
 uint8_t volatile ifft_status = 0;
