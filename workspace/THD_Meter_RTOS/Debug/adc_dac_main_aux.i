...
# 363 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\ADC_DAC/adc_dac_init.h"
 static inline void dac_init()
 {
  ...
  Chip_DAC_SetDMATimeOut(((LPC_DAC_T *) 0x4008C000), (SystemCoreClock/4) / (20000 * 8) );
...
# 63 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\inc/header.h"
 void main_while();
# 12 "../ADC_DAC/adc_dac_main_aux.c" 2
...
#define BYTE_TO_BINARY_2(byte) (byte & 0x02 ? 1 : 0), (byte & 0x01 ? 1 : 0)




#define BYTE_TO_BINARY_8(byte) (byte & 0x80 ? 1 : 0), (byte & 0x40 ? 1 : 0), (byte & 0x20 ? 1 : 0), (byte & 0x10 ? 1 : 0), (byte & 0x08 ? 1 : 0), (byte & 0x04 ? 1 : 0), (byte & 0x02 ? 1 : 0), (byte & 0x01 ? 1 : 0)
# 50 "../ADC_DAC/adc_dac_main_aux.c"
#define BYTE_TO_BINARY_16(byte) (byte & 0x8000 ? 1 : 0), (byte & 0x4000 ? 1 : 0), (byte & 0x2000 ? 1 : 0), (byte & 0x1000 ? 1 : 0), (byte & 0x0800 ? 1 : 0), (byte & 0x0400 ? 1 : 0), (byte & 0x0200 ? 1 : 0), (byte & 0x0100 ? 1 : 0), (byte & 0x0080 ? 1 : 0), (byte & 0x0040 ? 1 : 0), (byte & 0x0020 ? 1 : 0), (byte & 0x0010 ? 1 : 0), (byte & 0x0008 ? 1 : 0), (byte & 0x0004 ? 1 : 0), (byte & 0x0002 ? 1 : 0), (byte & 0x0001 ? 1 : 0)
# 69 "../ADC_DAC/adc_dac_main_aux.c"
#define BYTE_TO_BINARY_32(byte) (byte & 0x80000000 ? 1 : 0), (byte & 0x40000000 ? 1 : 0), (byte & 0x20000000 ? 1 : 0), (byte & 0x10000000 ? 1 : 0), (byte & 0x08000000 ? 1 : 0), (byte & 0x04000000 ? 1 : 0), (byte & 0x02000000 ? 1 : 0), (byte & 0x01000000 ? 1 : 0), (byte & 0x00800000 ? 1 : 0), (byte & 0x00400000 ? 1 : 0), (byte & 0x00200000 ? 1 : 0), (byte & 0x00100000 ? 1 : 0), (byte & 0x00080000 ? 1 : 0), (byte & 0x00040000 ? 1 : 0), (byte & 0x00020000 ? 1 : 0), (byte & 0x00010000 ? 1 : 0), (byte & 0x00008000 ? 1 : 0), (byte & 0x00004000 ? 1 : 0), (byte & 0x00002000 ? 1 : 0), (byte & 0x00001000 ? 1 : 0), (byte & 0x00000800 ? 1 : 0), (byte & 0x00000400 ? 1 : 0), (byte & 0x00000200 ? 1 : 0), (byte & 0x00000100 ? 1 : 0), (byte & 0x00000080 ? 1 : 0), (byte & 0x00000040 ? 1 : 0), (byte & 0x00000020 ? 1 : 0), (byte & 0x00000010 ? 1 : 0), (byte & 0x00000008 ? 1 : 0), (byte & 0x00000004 ? 1 : 0), (byte & 0x00000002 ? 1 : 0), (byte & 0x00000001 ? 1 : 0)
# 105 "../ADC_DAC/adc_dac_main_aux.c"
 void main_dac_aux()
 {
# 236 "../ADC_DAC/adc_dac_main_aux.c"
 }
