# 1 "../ADC_DAC/private/adc_dac_func_priv.c"
...
#define __REDLIB__ 1
# 1 "../ADC_DAC/private/adc_dac_func_priv.c"
# 10 "../ADC_DAC/private/adc_dac_func_priv.c"
...
#define DAC_DATA 0, 9
# 11 "../ADC_DAC/private/adc_dac_func_priv.c" 2
...
# 12 "../ADC_DAC/private/adc_dac_func_priv.c" 2
 ...
 void adc_ext_pre_procesamiento()
 {
  if(((dma_adc_ext_status & 0x06)))
  {
   ...
   for(int i=0; i<2048; i++)
   {
    ...
    xQueueGiveFromISR( ( QueueHandle_t ) ( sem_adc_ext_proc ), ( &pxHigherPiorityTaskWoken ) );
