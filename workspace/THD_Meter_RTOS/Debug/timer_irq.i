...
{
 if (Chip_TIMER_MatchPending(((LPC_TIMER_T *) 0x40004000), 1))
 {
  Chip_TIMER_ClearMatch(((LPC_TIMER_T *) 0x40004000), 1);
 }
}

void TIMER1_IRQHandler( void )
{
 if( Chip_TIMER_MatchPending(((LPC_TIMER_T *) 0x40008000), 0) )
 {
  Chip_GPIO_SetPinOutHigh(((LPC_GPIO_T *) 0x2009C000), 2,4);
  Chip_TIMER_ClearMatch(((LPC_TIMER_T *) 0x40008000), 0);
 }
 if( Chip_TIMER_MatchPending(((LPC_TIMER_T *) 0x40008000), 1) )
 {

  Chip_GPIO_SetPinOutLow(((LPC_GPIO_T *) 0x2009C000), 2,4);
  Chip_TIMER_ClearMatch(((LPC_TIMER_T *) 0x40008000), 1);
 }
}
