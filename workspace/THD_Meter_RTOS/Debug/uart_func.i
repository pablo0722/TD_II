...
# 12 "../UART/uart_func.c" 2
    ...
    void uart0_leer(uint8_t *buffer_in_A, uint8_t *buffer_in_B, uint32_t buffer_len)
    {
     ...
     {
      uart0_in_A = 
# 31 "../UART/uart_func.c" 3 4
                  ((void *)0)
# 31 "../UART/uart_func.c"
                      ;
      uart0_in_B = 
# 32 "../UART/uart_func.c" 3 4
                  ((void *)0)
# 32 "../UART/uart_func.c"
                      ;
      uart0_in_len = 0;
      uart0_in = 
# 34 "../UART/uart_func.c" 3 4
                ((void *)0)
# 34 "../UART/uart_func.c"
                    ;
      uart0_in_status = -1;
    ...
    void uart1_leer(uint8_t *buffer_in_A, uint8_t *buffer_in_B, uint32_t buffer_len)
    {
     ...
     {
      uart1_in_A = 
# 55 "../UART/uart_func.c" 3 4
                  ((void *)0)
# 55 "../UART/uart_func.c"
                      ;
      uart1_in_B = 
# 56 "../UART/uart_func.c" 3 4
                  ((void *)0)
# 56 "../UART/uart_func.c"
                      ;
      uart1_in_len = 0;
      uart1_in = 
# 58 "../UART/uart_func.c" 3 4
                ((void *)0)
# 58 "../UART/uart_func.c"
                    ;
      uart1_in_status = -1;
...
# 117 "../UART/uart_func.c"
    uint8_t *uart0_puedo_procesar()
    {
     if( (uart0_in_status == -3) || (uart0_in_status == 3) )
     {
      return uart0_in_A;
     }
     else if( (uart0_in_status == -2) || (uart0_in_status == 1) )
     {
      return uart0_in_B;
     }

     return 
# 128 "../UART/uart_func.c" 3 4
           ((void *)0)
# 128 "../UART/uart_func.c"
               ;
    }
    ...
    uint8_t *uart1_puedo_procesar()
    {
     if( (uart1_in_status == -3) || (uart1_in_status == 3) )
     {
      return uart1_in_A;
     }
     else if( (uart1_in_status == -2) || (uart1_in_status == 1) )
     {
      return uart1_in_B;
     }

     return 
# 144 "../UART/uart_func.c" 3 4
           ((void *)0)
# 144 "../UART/uart_func.c"
               ;
    }
# 183 "../UART/uart_func.c"
    void uart0_proceso_listo()
    {
     if(uart0_in_status == 3)
     {
      uart0_in_status = 2;
     }
     else if(uart0_in_status == -3)
     {
      uart0_in_status = 1;
      uart0_in = uart0_in_A;
     }
     else if(uart0_in_status == 1)
     {
      uart0_in_status = 0;
     }
     else if(uart0_in_status == -2)
     {
      uart0_in_status = 3;
      uart0_in = uart0_in_B;
     }
    ...
    void uart1_proceso_listo()
    {
     if(uart1_in_status == 3)
     {
      uart1_in_status = 2;
     }
     else if(uart1_in_status == -3)
     {
      uart1_in_status = 1;
      uart1_in = uart1_in_A;
     }
     else if(uart1_in_status == 1)
     {
      uart1_in_status = 0;
     }
     else if(uart1_in_status == -2)
     {
      uart1_in_status = 3;
      uart1_in = uart1_in_B;
     }
    }
# 281 "../UART/uart_func.c"
    Bool uart0_escribir(const uint8_t *buffer_out, uint32_t buffer_len)
    {
     if( (uart0_out_status == 1) || (uart0_out_status == 3) )
      return FALSE;

     if(uart0_out_status == 0)
     {
      uart0_out_B = buffer_out;
      uart0_out_len = uart0_out_len_B = buffer_len;
      uart0_out_status = 1;
     }
     else if(uart0_out_status == 2)
     {
    ...
    Bool uart1_escribir(const uint8_t *buffer_out, uint32_t buffer_len)
    {
     if( (uart1_out_status == 1) || (uart1_out_status == 3) )
      return FALSE;

     if(uart1_out_status == 0)
     {
      uart1_out_B = buffer_out;
      uart1_out_len = uart1_out_len_B = buffer_len;
      uart1_out_status = 1;
     }
     else if(uart1_out_status == 2)
     {
...
# 403 "../UART/uart_func.c"
    Bool uart0_escribiendo()
    {
     return (uart0_out_status != -1);
    }
