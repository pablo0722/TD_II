...
void dma_init();
	...
	STATIC INLINE void i2s_init()
	{
		...
		pin_init(I2SRX_CLK,  MD_PLN, IOCON_FUNC1);
		pin_init(I2SRX_SDA, MD_PLN, IOCON_FUNC1);
		pin_init(I2SRX_WS,  MD_PLN, IOCON_FUNC1);
		pin_init(RX_MCLK,   MD_PLN, IOCON_FUNC1);
		// Configuro los pines del TX de P0, ver defines
		pin_init(I2STX_CLK,  MD_PLN, IOCON_FUNC1);
		pin_init(I2STX_SDA,  MD_PLN, IOCON_FUNC1);
		pin_init(I2STX_WS,   MD_PLN, IOCON_FUNC1);
		pin_init(TX_MCLK,    MD_PLN, IOCON_FUNC1);
	...
	STATIC INLINE void dac_init()
	{
		...
		pin_init(0, 26, MD_PLN, IOCON_FUNC2); // P0[26] -> AOUT (salida de DAC)
