...
# 11 "../ADC_DAC/adc_dac_irq.c" 2
 ...
 void DMA_IRQHandler(void)
 {
   ...
   if(Chip_GPDMA_Interrupt(((LPC_GPDMA_T *) 0x50004000), dma_adc_ext_canal) == SUCCESS)
   {
...
# 128 "../ADC_DAC/adc_dac_irq.c"
   if(Chip_GPDMA_Interrupt(((LPC_GPDMA_T *) 0x50004000), dma_dac_ext_canal) == SUCCESS)
   {
    BaseType_t pxHigherPiorityTaskWoken = ( ( BaseType_t ) 0 );
    xQueueGiveFromISR( ( QueueHandle_t ) ( sem_dac_ext_finish ), ( &pxHigherPiorityTaskWoken ) );
