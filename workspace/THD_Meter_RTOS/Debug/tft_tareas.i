...
# 24 "../TFT/tft_tareas.c"
 ...
 void vtask_tft_display(void *pvParameters)
 {
  ...
  tft_Puts(0, 0, "TECNICAS DIGITALES", &tft_Font_16x26, 0x07E0, 0x0000);
  tft_Puts(120, 25, "II", &tft_Font_16x26, 0x07E0, 0x0000);
  tft_Puts(0, 50, "PROCESAMIENTO DE", &tft_Font_16x26, 0x001F, 0x0000);
  tft_Puts(100, 75, "AUDIO", &tft_Font_16x26, 0x001F, 0x0000);
  tft_Puts(0, 100, "MENU", &tft_Font_16x26, 0x001F, 0x0000);
  tft_Puts(50, 125, "Reverb", &tft_Font_16x26, 0x001F, 0x0000);
  tft_Puts( 50, 150, "Echo", &tft_Font_16x26, 0x001F, 0x0000);
  tft_Puts(50, 175, "High Pass Filter", &tft_Font_16x26, 0x001F, 0x0000);
  tft_Puts(50, 200, "Low Pass Filter", &tft_Font_16x26, 0x001F, 0x0000);

  tft_DrawFilledCircle(30, 135, 7, 0x001F);
  tft_DrawFilledCircle(30, 160, 7, 0x001F);
  tft_DrawFilledCircle(30, 185, 7, 0x001F);
  tft_DrawFilledCircle(30, 210, 7, 0x001F);
