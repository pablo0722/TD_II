...
.L22:
	...
	cmpeq	r1, r3
	bcs	.L35
	.loc 5 37 0 discriminator 2
	ldr	r3, [r7, #44]
	subs	r3, r3, #1
	str	r3, [r7, #44]
.L19:
	.loc 5 37 0 is_stmt 0 discriminator 1
	ldr	r3, [r7, #44]
	cmp	r3, #0
	bne	.L22
	b	.L21
...
.L41:
	...
	cmp	r3, #1
	bne	.L43
	.loc 5 109 0 is_stmt 0 discriminator 1
	movs	r3, #4
	b	.L44
.L43:
	.loc 5 109 0 discriminator 2
	movs	r3, #0
.L44:
	.loc 5 109 0 discriminator 4
	ldr	r2, [r7, #20]
	orrs	r3, r3, r2
	str	r3, [r7, #20]
	.loc 5 111 0 is_stmt 1 discriminator 4
	ldr	r3, [r7]
	ldrb	r3, [r3, #5]	@ zero_extendqisi2
	subs	r3, r3, #1
	lsls	r3, r3, #6
	...
	ldr	r2, [r7, #20]
	str	r2, [r3]
	.loc 5 114 0 discriminator 4
	ldr	r3, [r7, #4]
	movs	r2, #8
	str	r2, [r3, #48]
	.loc 5 116 0 discriminator 4
	movs	r0, #27
	bl	Chip_Clock_GetPeripheralClockRate
	.loc 5 118 0 discriminator 4
	movs	r3, #32
	strh	r3, [r7, #18]	@ movhi
	.loc 5 119 0 discriminator 4
	movs	r3, #125
	strh	r3, [r7, #16]	@ movhi
	.loc 5 121 0 discriminator 4
	ldr	r3, [r7, #4]
	movs	r2, #5
	str	r2, [r3, #40]
	.loc 5 123 0 discriminator 4
	ldrh	r3, [r7, #16]
	mov	r2, r3
	ldrh	r3, [r7, #18]
	lsls	r3, r3, #8
...
.L53:
	...
	orrs	r3, r3, r2
	str	r3, [r7, #20]
	.loc 5 154 0 is_stmt 1 discriminator 4
	ldr	r3, [r7]
	ldrb	r3, [r3, #5]	@ zero_extendqisi2
	subs	r3, r3, #1
	lsls	r3, r3, #6
	...
	orrs	r3, r3, r2
	str	r3, [r7, #20]
	.loc 5 155 0 discriminator 4
	ldr	r3, [r7, #4]
	ldr	r2, [r7, #20]
	str	r2, [r3, #4]
	.loc 5 157 0 discriminator 4
	ldr	r3, [r7, #4]
	movs	r2, #8
	str	r2, [r3, #52]
	.loc 5 159 0 discriminator 4
	movs	r0, #27
	bl	Chip_Clock_GetPeripheralClockRate
	.loc 5 161 0 discriminator 4
	movs	r3, #32
	strh	r3, [r7, #18]	@ movhi
	.loc 5 162 0 discriminator 4
	movs	r3, #125
	strh	r3, [r7, #16]	@ movhi
	.loc 5 164 0 discriminator 4
	ldr	r3, [r7, #4]
	movs	r2, #5
	str	r2, [r3, #44]
	.loc 5 166 0 discriminator 4
	ldrh	r3, [r7, #16]
	mov	r2, r3
	ldrh	r3, [r7, #18]
	lsls	r3, r3, #8
	...
	ldr	r3, [r7, #4]
	str	r2, [r3, #36]
	.loc 5 167 0 discriminator 4
	movs	r3, #1
.L54:
	.loc 5 168 0 discriminator 1
	mov	r0, r3
	adds	r7, r7, #24
	.cfi_def_cfa_offset 8
	mov	sp, r7
...
.LC10:
	...
	.align	2
.LC11:
	.ascii	"vTask_teclado\000"
	.section	.text.main_task_init,"ax",%progbits
	.align	2
	.thumb
	.thumb_func
	.type	main_task_init, %function
main_task_init:
.LFB380:
	.loc 6 29 0
	.cfi_startproc
...
.L66:
	...
	.cfi_endproc
.LFE380:
	.size	main_task_init, .-main_task_init
...
.LFE381:
	...
	.section	.bss.init_flag.10209,"aw",%nobits
	.type	init_flag.10209, %object
	.size	init_flag.10209, 1
init_flag.10209:
	.space	1
...
.Letext0:
	...
	.file 14 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\LibFreeRTOS_8.2.3\\inc/task.h"
...
.Ldebug_macro0:
	...
	.uleb128 0x9
	.4byte	.LASF364
	.file 21 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\inc/header.h"
	.byte	0x3
	.uleb128 0x9
	.uleb128 0x15
	.byte	0x5
	.uleb128 0xa
	.4byte	.LASF365
	.file 22 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\inc/utilidades.h"
	.byte	0x3
	.uleb128 0xc
	.uleb128 0x16
	.byte	0x5
	.uleb128 0x9
	.4byte	.LASF366
	.file 23 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\LibFreeRTOS_8.2.3\\inc/FreeRTOS.h"
	.byte	0x3
	.uleb128 0xc
	.uleb128 0x17
	.byte	0x5
	...
	.4byte	.Ldebug_macro4
	.byte	0x4
	.file 28 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\LibFreeRTOS_8.2.3\\inc/FreeRTOSConfig.h"
	.byte	0x3
	.uleb128 0x62
	.uleb128 0x1c
	.byte	0x5
	.uleb128 0x4
	.4byte	.LASF640
	.file 29 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\lpc_myboard_1769\\inc/board.h"
	.byte	0x3
	.uleb128 0x8
	.uleb128 0x1d
	.byte	0x5
	...
	.4byte	.Ldebug_macro6
	.byte	0x4
	.file 31 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\lpc_chip_175x_6x\\inc/sys_config.h"
	.byte	0x3
	.uleb128 0x24
	.uleb128 0x1f
	.byte	0x7
	...
	.file 35 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\lpc_chip_175x_6x\\inc/sysctl_17xx_40xx.h"
	.byte	0x3
	.uleb128 0xa2
	.uleb128 0x23
	.byte	0x7
	...
	.byte	0x4
	.file 39 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\lpc_chip_175x_6x\\inc/gpdma_17xx_40xx.h"
	.byte	0x3
	.uleb128 0xa9
	.uleb128 0x27
	.byte	0x7
	...
	.file 74 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\TIMER/timer_init.h"
	.byte	0x3
	.uleb128 0x21
	.uleb128 0x4a
	.byte	0x4
...
.Ldebug_macro56:
	...
	.4byte	.LASF2666
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.adc_dac_header.h.9.c614cabd58380acad27b8a8a16fba057,comdat
.Ldebug_macro57:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.Ldebug_macro58:
	...
	.4byte	.LASF2688
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.tft_header.h.9.56bf475f66490ad0d6e87109272aa090,comdat
.Ldebug_macro59:
	.2byte	0x4
	.byte	0
	.byte	0x5
	...
	.4byte	.LASF2791
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.rtos_header.h.11.2aef1465dd78dfd1faa87f677a53c010,comdat
.Ldebug_macro60:
	.2byte	0x4
	.byte	0
	.byte	0x5
