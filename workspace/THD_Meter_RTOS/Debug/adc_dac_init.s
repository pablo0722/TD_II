...
.L33:
	...
	cmpeq	r1, r3
	bcs	.L46
	.loc 5 164 0 discriminator 2
	ldr	r3, [r7, #44]
	subs	r3, r3, #1
	str	r3, [r7, #44]
.L30:
	.loc 5 164 0 is_stmt 0 discriminator 1
	ldr	r3, [r7, #44]
	cmp	r3, #0
	bne	.L33
	b	.L32
...
.L47:
	...
	nop
.L38:
	.loc 5 173 0 discriminator 2
	ldr	r3, [r7, #52]
	subs	r3, r3, #1
	str	r3, [r7, #52]
.L36:
	.loc 5 173 0 is_stmt 0 discriminator 1
	ldr	r3, [r7, #52]
	cmp	r3, #0
	bne	.L43
.L42:
...
.L54:
	...
	movs	r3, #0
.L55:
	.loc 5 236 0 discriminator 4
	ldr	r2, [r7, #20]
	orrs	r3, r3, r2
	str	r3, [r7, #20]
	.loc 5 238 0 is_stmt 1 discriminator 4
	ldr	r3, [r7]
	ldrb	r3, [r3, #5]	@ zero_extendqisi2
	subs	r3, r3, #1
	lsls	r3, r3, #6
	...
	orrs	r3, r3, r2
	str	r3, [r7, #20]
	.loc 5 239 0 discriminator 4
	ldr	r3, [r7, #4]
	ldr	r2, [r7, #20]
	str	r2, [r3]
	.loc 5 241 0 discriminator 4
	ldr	r3, [r7, #4]
	movs	r2, #8
	str	r2, [r3, #48]
	.loc 5 243 0 discriminator 4
	movs	r0, #27
	bl	Chip_Clock_GetPeripheralClockRate
	.loc 5 245 0 discriminator 4
	movs	r3, #32
	strh	r3, [r7, #18]	@ movhi
	.loc 5 246 0 discriminator 4
	movs	r3, #125
	strh	r3, [r7, #16]	@ movhi
	.loc 5 248 0 discriminator 4
	ldr	r3, [r7, #4]
	movs	r2, #5
	str	r2, [r3, #40]
	.loc 5 250 0 discriminator 4
	ldrh	r3, [r7, #16]
	mov	r2, r3
	ldrh	r3, [r7, #18]
	lsls	r3, r3, #8
...
.L64:
	...
	orrs	r3, r3, r2
	str	r3, [r7, #20]
	.loc 5 281 0 is_stmt 1 discriminator 4
	ldr	r3, [r7]
	ldrb	r3, [r3, #5]	@ zero_extendqisi2
	subs	r3, r3, #1
	lsls	r3, r3, #6
	...
	orrs	r3, r3, r2
	str	r3, [r7, #20]
	.loc 5 282 0 discriminator 4
	ldr	r3, [r7, #4]
	ldr	r2, [r7, #20]
	str	r2, [r3, #4]
	.loc 5 284 0 discriminator 4
	ldr	r3, [r7, #4]
	movs	r2, #8
	str	r2, [r3, #52]
	.loc 5 286 0 discriminator 4
	movs	r0, #27
	bl	Chip_Clock_GetPeripheralClockRate
	.loc 5 288 0 discriminator 4
	movs	r3, #32
	strh	r3, [r7, #18]	@ movhi
	.loc 5 289 0 discriminator 4
	movs	r3, #125
	strh	r3, [r7, #16]	@ movhi
	.loc 5 291 0 discriminator 4
	ldr	r3, [r7, #4]
	movs	r2, #5
	str	r2, [r3, #44]
	.loc 5 293 0 discriminator 4
	ldrh	r3, [r7, #16]
	mov	r2, r3
	ldrh	r3, [r7, #18]
	lsls	r3, r3, #8
	...
	ldr	r3, [r7, #4]
	str	r2, [r3, #36]
	.loc 5 294 0 discriminator 4
	movs	r3, #1
.L65:
	.loc 5 295 0 discriminator 1
	mov	r0, r3
	adds	r7, r7, #24
	.cfi_def_cfa_offset 8
	mov	sp, r7
...
.L70:
	.align	2
.L69:
	.word	sem_adc_ext_proc
	.word	sem_dac_ext_finish
	.word	1074429952
	.cfi_endproc
.LFE384:
...
.Ldebug_macro53:
	...
	.4byte	.LASF2631
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.utilidades.h.27.88b17ba9a9381dcec834d5d9f71d73bf,comdat
.Ldebug_macro54:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.Ldebug_macro61:
	...
	.4byte	.LASF2774
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.adc_dac_header_priv.h.9.35d26f8b3e7827fd7da36bc65a50b701,comdat
.Ldebug_macro62:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF2800:
	.ascii	"STATUS_ADC_ISPROC(status) ((status & 0x06))\000"
.LASF2883:
	.ascii	"IABR\000"
.LASF1830:
...
.LASF2801:
	.ascii	"STATUS_ADC_ISERR(status) (status & 0x04)\000"
.LASF1928:
...
.LASF2788:
	.ascii	"TX_CONFIG TX_CONFIG_ADA\000"
.LASF969:
...
.LASF2792:
	.ascii	"TX_MCLK 4, 29, MD_PLN, IOCON_FUNC1\000"
.LASF1742:
...
.LASF2651:
	.ascii	"DAC_INTERNO_MODO DAC_INTERNO_DMA\000"
.LASF403:
...
.LASF2780:
	.ascii	"RX_CONFIG RX_CONFIG_ADA\000"
.LASF2855:
	.ascii	"RTC_IRQn\000"
.LASF2748:
	.ascii	"SALIDA 1\000"
...
.LASF2784:
	.ascii	"RX_MCLK 4, 28, MD_PLN, IOCON_FUNC1\000"
.LASF1070:
