...
# 121 "../UART/uart_header.h" 2
# 11 "../UART/uart_irq.c" 2
...
# 12 "../UART/uart_irq.c" 2
  ...
  {
   if(uart0_out_status != -1)
   {
    if (Chip_UART_GetIntsEnabled(((LPC_USART_T *) 0x4000C000)) & (1 << 1))
    {
     Chip_UART_SendByte(((LPC_USART_T *) 0x4000C000), uart0_out[uart0_out_idx]);
     uart0_out_idx++;
     uart0_out_idx %= uart0_out_len;

     if(!uart0_out_idx)
     {
      if( (uart0_out_status == 0) || (uart0_out_status == 2) )
      {
       uart0_out_status = -1;
      }
      else if(uart0_out_status == 1)
      {
       uart0_out_status = 2;
       uart0_out = uart0_out_B;
       uart0_out_len = uart0_out_len_B;
      }
      else if(uart0_out_status == 3)
      {
       uart0_out_status = 0;
   ...
   while(Chip_UART_ReadLineStatus(((LPC_USART_T *) 0x4000C000)) & (1 << 0))
   {
    uint8_t read_char = Chip_UART_ReadByte(((LPC_USART_T *) 0x4000C000));

    if(uart0_in_status > -1)
    {
  ...
  {
   if(uart1_out_status != -1)
   {
    if (((LPC_USART_T *) 0x40010000)->IER & (1 << 1))
    {
     Chip_UART_SendByte(((LPC_USART_T *) 0x40010000), uart1_out[uart1_out_idx]);
     uart1_out_idx++;
     uart1_out_idx %= uart1_out_len;

     if(!uart1_out_idx)
     {
      if( (uart1_out_status == 0) || (uart1_out_status == 2) )
      {
       uart1_out_status = -1;
      }
      else if(uart1_out_status == 1)
      {
       uart1_out_status = 2;
       uart1_out = uart1_out_B;
       uart1_out_len = uart1_out_len_B;
      }
      else if(uart1_out_status == 3)
      {
       uart1_out_status = 0;
   ...
   while(Chip_UART_ReadLineStatus(((LPC_USART_T *) 0x40010000)) & (1 << 0))
   {
    uint8_t read_char = Chip_UART_ReadByte(((LPC_USART_T *) 0x40010000));

    if(uart1_in_status > -1)
    {
