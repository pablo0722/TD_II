...
# 10 "../ADC_DAC/adc_dac_irq.c" 2
 ...
 void DMA_IRQHandler(void)
 {
   ...
   {
    if(dma_adc_ext_status == 0x00)
    {
     dma_adc_ext_status = 0x03;
    ...
    else if(dma_adc_ext_status == 0x01)
    {
     dma_adc_ext_status = 0x02;
   ...
   if(Chip_GPDMA_Interrupt(((LPC_GPDMA_T *) 0x50004000), dma_dac_int_canal))
   {
    ...
    else if(dma_dac_int_status == 0x03)
    {
