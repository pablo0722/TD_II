...
// ********* FUNCIONES ********** //
	#if (USE_ADC_EXTERNO)
		void main_adc_pre();	// Funcion que debe ejecutar luego de recibir los datos, antes de procesar
...
// ************* VARIABLES GLOBALES ************* //
		...
		extern volatile uint32_t *dma_adc_ext_memory;							// Apunta al buffer actual del ADC (el que se puede procesar)
	...
	#if USE_DAC_INTERNO
		extern Bool flag_use_dac;		// Indica si se usa el DAC
