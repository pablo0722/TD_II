...
# 9 "../RTOS/rtos_tareas.c" 2
 ...
 void vTask_THD( void *pvParameters )
 {
  ...
  if(xQueueGenericReceive( ( xQueue_in ), ( fft_in ), ( 0 ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ))
  {

   fft_function();


   for(i=2; i*fft_max_index < 512; i++)
   {
   ...
   xQueueGenericSend( ( xQueue_rem ), ( fft_out_dep ), ( 0 ), ( ( BaseType_t ) 0 ) );
  }
 }

 void vTask_Remanente( void *pvParameters )
 {
# 59 "../RTOS/rtos_tareas.c"
 }
