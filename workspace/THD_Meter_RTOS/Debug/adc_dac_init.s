...
.L52:
	...
	movs	r3, #0
.L53:
	.loc 4 236 0 discriminator 4
	ldr	r2, [r7, #20]
	orrs	r3, r3, r2
	str	r3, [r7, #20]
	.loc 4 238 0 is_stmt 1 discriminator 4
	ldr	r3, [r7]
	ldrb	r3, [r3, #5]	@ zero_extendqisi2
	subs	r3, r3, #1
	lsls	r3, r3, #6
...
.L61:
	...
	movs	r3, #0
.L62:
	.loc 4 279 0 discriminator 4
	ldr	r2, [r7, #20]
	orrs	r3, r3, r2
	str	r3, [r7, #20]
	.loc 4 281 0 is_stmt 1 discriminator 4
	ldr	r3, [r7]
	ldrb	r3, [r3, #5]	@ zero_extendqisi2
	subs	r3, r3, #1
	lsls	r3, r3, #6
