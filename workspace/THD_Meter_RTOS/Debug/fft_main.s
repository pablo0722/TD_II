...
.LFE371:
	...
	.section	.text.fft_function,"ax",%progbits
	.align	2
	.global	fft_function
	.thumb
	.thumb_func
	.type	fft_function, %function
fft_function:
.LFB376:
	.file 2 "../FFT/fft_main.c"
	.loc 2 16 0
	.cfi_startproc
...
.L23:
	...
	.cfi_endproc
.LFE376:
	.size	fft_function, .-fft_function
	.section	.text.ifft_function,"ax",%progbits
	.align	2
	.global	ifft_function
	.thumb
	.thumb_func
	.type	ifft_function, %function
ifft_function:
.LFB377:
	.loc 2 41 0
	.cfi_startproc
...
.L28:
	...
	.cfi_endproc
.LFE377:
	.size	ifft_function, .-ifft_function
	.text
.Letext0:
...
.Ldebug_macro57:
	...
	.4byte	.LASF2697
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.adc_dac_header.h.9.06b45ba717e900a7ed32aa0a39a9e6b9,comdat
.Ldebug_macro58:
	.2byte	0x4
	.byte	0
	.byte	0x5
