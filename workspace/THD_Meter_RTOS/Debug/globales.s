...
.Ltext0:
	...
	.size	buffer_complex, 8192
buffer_complex:
	.space	8192
	.global	buffer_dac_out
	.align	2
	.type	buffer_dac_out, %object
	.size	buffer_dac_out, 4096
buffer_dac_out:
	.space	4096
	.global	buffer_dep
	.align	2
	.type	buffer_dep, %object
	.size	buffer_dep, 4096
buffer_dep:
	.space	4096
	.global	buffer_dac
	.align	2
	.type	buffer_dac, %object
	.size	buffer_dac, 2048
buffer_dac:
	.space	2048
	.text
.Letext0:
