...
#define UART_MODE_LOOPBACK 1
#define UART_MODE_FFT 2
...
# 42 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\UART/uart_header.h"
...
# 80 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\UART/uart_header.h"
...
# 15 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\UART/uart_init.h"
  static inline void init_uart0()
  {
   ...
   Chip_UART_IntEnable(((LPC_USART_T *) 0x4000C000), ((1 << 0) | (1 << 1) | (1 << 2)));
  ...
  static inline void init_uart1()
  {
   ...
   Chip_UART_IntEnable(((LPC_USART_T *) 0x40010000), ((1 << 0) | (1 << 1) | (1 << 2)));
   ...
   while(uart1_escribiendo());
  }
# 130 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\UART/uart_init.h"
...
#define PINGPONG_DAC_TRANS2ERR(status) status -= 0x02
  ...
  extern volatile uint32_t dma_adc_ext_memory_A[2048];
  extern volatile uint32_t dma_adc_ext_memory_B[2048];
  ...
  extern volatile uint16_t dma_dac_int_memory_A[2048];
  extern volatile uint16_t dma_dac_int_memory_B[2048];
...
# 325 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\ADC_DAC/adc_dac_init.h" 3 4
  ((void *)0) 
# 325 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\ADC_DAC/adc_dac_init.h"
...
# 326 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\ADC_DAC/adc_dac_init.h" 3 4
  ((void *)0)
# 326 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\ADC_DAC/adc_dac_init.h"
  , ( 0 ), ( ( BaseType_t ) 0 ) );
...
# 407 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\ADC_DAC/adc_dac_init.h"
...
# 27 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\TIMER/timer_header.h"
#define TIMER0_TICKRATE 50
   ...
   extern SemaphoreHandle_t sem_timer0_match1;
   extern SemaphoreHandle_t sem_timer1_match0;
   extern SemaphoreHandle_t sem_timer1_match1;
...
# 20 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\TFT/tft_header.h"
 typedef enum
 {
...
# 19 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\inc/header.h" 2
 ...
 void main_while();
# 2 "../TFT/tft_Init.c" 2
# 1 "../TFT/tft_private_func.h" 1
# 9 "../TFT/tft_private_func.h"
...
void tft_init()
{
 ...
 playBL(60, 1);
  ...
  xTaskGenericCreate( ( vTask_tft_BL ), ( "vTask_tft_BL" ), ( ( ( unsigned short ) 128 ) ), ( 
# 31 "../TFT/tft_Init.c" 3 4
 ((void *)0) 
# 31 "../TFT/tft_Init.c"
 ), ( (( ( UBaseType_t ) 0U ) + 1UL) ), ( (TaskHandle_t *) 
# 31 "../TFT/tft_Init.c" 3 4
 ((void *)0) 
# 31 "../TFT/tft_Init.c"
 ), ( 
...
# 31 "../TFT/tft_Init.c"
  ...
  xTaskGenericCreate( ( vtask_tft_display ), ( "vtask_tft_display" ), ( ( ( unsigned short ) 128 ) ), ( 
# 32 "../TFT/tft_Init.c" 3 4
 ((void *)0) 
# 32 "../TFT/tft_Init.c"
 ), ( (( ( UBaseType_t ) 0U ) + 1UL) ), ( (TaskHandle_t *) 
# 32 "../TFT/tft_Init.c" 3 4
...
# 51 "../TFT/tft_Init.c"
 ...
 tft_DrawRectangle(2,2,60,40, 0xFFFF);
 tft_Puts(5, 5, "ECG", &TM_Font_11x18, 0x051D, 0x0000);
 tft_Puts(5, 70, "Cargando", &TM_Font_11x18, 0x051D, 0x0000);
 tft_Puts(5, 130, "Version 15.0", &TM_Font_11x18, 0x051D, 0x0000);
 tft_DrawFilledCircle(10, 160, 10, 0xFFE0);
 tft_DrawFilledCircle(50, 160, 10, 0x07E0);
 tft_DrawFilledCircle(90, 160, 10, 0xFFFF);
 tft_DrawFilledCircle(130, 160, 10, 0xFBE4);
}

static void tft_gpio_init_priv()
{
 Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 2,7, (0x2 << 2), 0x0);
 Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 2,7);
 Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 2,7,0);

 Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 1,29, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 1,29);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 1,29,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 4,28, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 4,28);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 4,28,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 1,23, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 1,23);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 1,23,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 1,20, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 1,20);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 1,20,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 0,19, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 0,19);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 0,19,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 3,26, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 3,26);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 3,26,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 1,25, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 1,25);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 1,25,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 1,22, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 1,22);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 1,22,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 1,19, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 1,19);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 1,19,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 0,20, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 0,20);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 0,20,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 3,25, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 3,25);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 3,25,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 2,6, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 2,6);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000),2,6,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 1,24, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 1,24);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 1,24,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 1,21, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 1,21);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 1,21,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 1,18, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 1,18);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 1,18,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 0,9, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 0,9);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 0,9,1);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 0,8, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 0,8);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 0,8,0);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 0,7, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 0,7);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 0,7,1);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 0,6, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 0,6);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 0,6,1);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 2,5, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 2,5);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 2,5,1);

    Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 2,4, (0x2 << 2), 0x0);
    Chip_GPIO_SetPinDIROutput(((LPC_GPIO_T *) 0x2009C000), 2,4);
    Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000),2,4,0);
}

static void tft_LCD_Init_priv()
{
  Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 2,5,0);
  Chip_GPIO_SetPinState(((LPC_GPIO_T *) 0x2009C000), 2,5,1);

  tft_SendCommand_priv(0x01);
  tft_Delay_priv(2000000);

  tft_SendCommand_priv(0xCB);
  tft_SendData_priv(0x39);
  tft_SendData_priv(0x2C);
  tft_SendData_priv(0x00);
  tft_SendData_priv(0x34);
  tft_SendData_priv(0x02);
  tft_SendCommand_priv(0xCF);
  tft_SendData_priv(0x00);
  tft_SendData_priv(0xC1);
  tft_SendData_priv(0x30);
  tft_SendCommand_priv(0xE8);
  tft_SendData_priv(0x85);
  tft_SendData_priv(0x00);
  tft_SendData_priv(0x78);
  tft_SendCommand_priv(0xEA);
  tft_SendData_priv(0x00);
  tft_SendData_priv(0x00);
  tft_SendCommand_priv(0xED);
  tft_SendData_priv(0x64);
  tft_SendData_priv(0x03);
  tft_SendData_priv(0x12);
  tft_SendData_priv(0x81);
  tft_SendCommand_priv(0xF7);
  tft_SendData_priv(0x20);
  tft_SendCommand_priv(0xC0);
  tft_SendData_priv(0x23);
  tft_SendCommand_priv(0xC1);
  tft_SendData_priv(0x10);
  tft_SendCommand_priv(0xC5);
  tft_SendData_priv(0x3E);
  tft_SendData_priv(0x28);
  tft_SendCommand_priv(0xC7);
  tft_SendData_priv(0x86);
  tft_SendCommand_priv(0x36);
  tft_SendData_priv(0x48);
  tft_SendCommand_priv(0x3A);
  tft_SendData_priv(0x55);
  tft_SendCommand_priv(0xB1);
  tft_SendData_priv(0x00);
  tft_SendData_priv(0x18);
  tft_SendCommand_priv(0xB6);
  tft_SendData_priv(0x08);
  tft_SendData_priv(0x82);
  tft_SendData_priv(0x27);
  tft_SendCommand_priv(0xF2);
  tft_SendData_priv(0x00);
  tft_SendCommand_priv(0x2A);
  tft_SendData_priv(0x00);
  tft_SendData_priv(0x00);
  tft_SendData_priv(0x00);
  tft_SendData_priv(0xEF);
  tft_SendCommand_priv(0x2B);
  tft_SendData_priv(0x00);
  tft_SendData_priv(0x00);
  tft_SendData_priv(0x01);
  tft_SendData_priv(0x3F);
  tft_SendCommand_priv(0x26);
  tft_SendData_priv(0x01);
  tft_SendCommand_priv(0xE0);
  ...
  tft_SendData_priv(0x0F);
  tft_SendCommand_priv(0x53);
  tft_SendData_priv(0x2C);
  tft_SendCommand_priv(0xC0);
  tft_SendData_priv(0x09);
  tft_SendCommand_priv(0x11);

  tft_Delay_priv(1000000);

  tft_SendCommand_priv(0x29);
