...
# 10 "../ADC_DAC/adc_dac_irq.c" 2
 ...
 void DMA_IRQHandler(void)
 {
  ...
  int i;
   ...
   if(Chip_GPDMA_Interrupt(((LPC_GPDMA_T *) 0x50004000), canal_adc))
   {

    for(i=0; i<8; i++)
    {
     dma_memory_adc[i] = (dma_memory_adc[i]);
    }
    ...
    Chip_GPDMA_SGTransfer(((LPC_GPDMA_T *) 0x50004000), canal_dac,
          &DMA_descriptor_DAC,
     ...
     if(transf_success == ERROR)
     {
      ...
      printf("%d, %s", 41, "../ADC_DAC/adc_dac_irq.c");
     }
   ...
   if(Chip_GPDMA_Interrupt(((LPC_GPDMA_T *) 0x50004000), canal_dac))
   {
    ...
    Chip_GPDMA_SGTransfer(((LPC_GPDMA_T *) 0x50004000), canal_adc,
     ...
     {
      printf("[error] interrupcion DMA:");
      printf("%d, %s", 63, "../ADC_DAC/adc_dac_irq.c");
     }
