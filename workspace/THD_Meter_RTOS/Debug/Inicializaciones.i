...
static inline void main_gpio_init()
{
 ...
 pin_gpio_init(2, 10, (0x0), 0);
 pin_gpio_init(0, 18, (0x0), 0);
 pin_gpio_init(0, 11, (0x0), 0);
 pin_gpio_init(2, 13, (0x0), 0);
}

static inline void main_task_init()
{
 task_create(vTask_tft, "vTask_tft", ( ( unsigned short ) 128 ), 
# 23 "../src/Inicializaciones.c" 3 4
                                                                   ((void *)0)
# 23 "../src/Inicializaciones.c"
                                                                       , 0, (TaskHandle_t *) 
# 23 "../src/Inicializaciones.c" 3 4
                                                                                                           ((void *)0)
# 23 "../src/Inicializaciones.c"
...
# 24 "../src/Inicializaciones.c" 3 4
                                                                    ((void *)0)
# 24 "../src/Inicializaciones.c"
                                                                        , 0, (TaskHandle_t *) 
# 24 "../src/Inicializaciones.c" 3 4
                                                                                                            ((void *)0)
# 24 "../src/Inicializaciones.c"
...
# 25 "../src/Inicializaciones.c" 3 4
                                                                         ((void *)0)
# 25 "../src/Inicializaciones.c"
                                                                             , 0, (TaskHandle_t *) 
# 25 "../src/Inicializaciones.c" 3 4
                                                                                                                 ((void *)0)
# 25 "../src/Inicializaciones.c"
...
# 30 "../src/Inicializaciones.c" 3 4
                                ((void *)0)
# 30 "../src/Inicializaciones.c"
                                    );
}
