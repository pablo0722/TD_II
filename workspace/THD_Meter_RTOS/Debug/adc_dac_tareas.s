...
.LFE377:
	...
	.section	.text.main_adc_task_pre,"ax",%progbits
	.align	2
	.global	main_adc_task_pre
	.thumb
	.thumb_func
	.type	main_adc_task_pre, %function
main_adc_task_pre:
.LFB382:
	.file 2 "../ADC_DAC/adc_dac_tareas.c"
	.loc 2 15 0
	.cfi_startproc
...
.L22:
	...
	.cfi_endproc
.LFE382:
	.size	main_adc_task_pre, .-main_adc_task_pre
	.section	.text.main_adc_task_post,"ax",%progbits
	.align	2
	.global	main_adc_task_post
	.thumb
	.thumb_func
	.type	main_adc_task_post, %function
main_adc_task_post:
.LFB383:
	.loc 2 30 0
	.cfi_startproc
...
.L26:
	...
	.cfi_endproc
.LFE383:
	.size	main_adc_task_post, .-main_adc_task_post
	.text
.Letext0:
	...
	.file 16 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\UART/uart_header.h"
...
.LASF3015:
	.ascii	"../ADC_DAC/adc_dac_tareas.c\000"
.LASF2514:
