...
# 11 "../UART/uart_main.c" 2
  ...
  void main_uart0()
  {
   ...
   if(uart0_rx_status == 0)
   {
    uint8_t read_char = 0;
    int bytes = Chip_UART_ReadRB(((LPC_USART_T *) 0x4000C000), &rxring0, &read_char, 1);
...
# 47 "../UART/uart_main.c"
  ...
  void main_uart1()
  {
   ...
   {
    uint8_t read_char = 0;
    int bytes = Chip_UART_ReadRB(((LPC_USART_T *) 0x40010000), &rxring1, &read_char, 1);
