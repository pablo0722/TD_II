...
# 19 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\inc/header.h" 2
 ...
 void main_while();
# 11 "../ADC_DAC/adc_dac_tareas.c" 2



 void main_adc_task_pre()
 {
  xQueueGenericReceive( ( QueueHandle_t ) ( sem_adc_pre ), 
# 16 "../ADC_DAC/adc_dac_tareas.c" 3 4
 ((void *)0)
# 16 "../ADC_DAC/adc_dac_tareas.c"
 , ( 0 ), ( ( BaseType_t ) 0 ) );

  while(1)
  {
   xQueueGenericReceive( ( QueueHandle_t ) ( sem_adc_pre ), 
# 20 "../ADC_DAC/adc_dac_tareas.c" 3 4
  ((void *)0)
# 20 "../ADC_DAC/adc_dac_tareas.c"
  , ( 0 ), ( ( BaseType_t ) 0 ) );

   main_adc_pre();

   xQueueGenericSend( ( QueueHandle_t ) ( sem_adc_proc ), 
# 24 "../ADC_DAC/adc_dac_tareas.c" 3 4
  ((void *)0)
# 24 "../ADC_DAC/adc_dac_tareas.c"
 ...
 void main_adc_task_post()
 {
  xQueueGenericReceive( ( QueueHandle_t ) ( sem_adc_post ), 
# 31 "../ADC_DAC/adc_dac_tareas.c" 3 4
 ((void *)0)
# 31 "../ADC_DAC/adc_dac_tareas.c"
 , ( 0 ), ( ( BaseType_t ) 0 ) );

  while(1)
  {
   xQueueGenericReceive( ( QueueHandle_t ) ( sem_adc_post ), 
# 35 "../ADC_DAC/adc_dac_tareas.c" 3 4
  ((void *)0)
# 35 "../ADC_DAC/adc_dac_tareas.c"
  , ( 0 ), ( ( BaseType_t ) 0 ) );
