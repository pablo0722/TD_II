...
#define IRQn_UART(n) (n==0?UART0_IRQn: (n==1?UART1_IRQn: (n==2?UART2_IRQn: UART3_IRQn)))
 ...
 void init_uartN(uint8_t uart_num)
 {
   ...
   printf("\t Baudrate: %d \r\n", (uart_num==0?9600: (uart_num==1?9600: (uart_num==2?9600: 9600))));
   printf("\t SendBuffSize: %d \r\n", (uart_num==0?16: (uart_num==1?16: (uart_num==2?16: 16))));
  ...
  {
   Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 0, 10, (0x2), 0x1);
   Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 0, 11, (0x2), 0x1);
  }
  else
  {
   Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 0, 0, (0x2), 0x2);
   Chip_IOCON_PinMux(((LPC_IOCON_T *) 0x4002C000), 0, 1, (0x2), 0x2);
  }

  Board_UART_Init((uint32_t)(uart_num==0?((LPC_USART_T *) 0x4000C000): (uart_num==1?((LPC_USART_T *) 0x40010000): (uart_num==2?((LPC_USART_T *) 0x40098000): ((LPC_USART_T *) 0x4009C000)))), (uart_num==0?9600: (uart_num==1?9600: (uart_num==2?9600: 9600))));



  RingBuffer_Init((uart_num==0?&rxring0: (uart_num==1?
# 150 "../UART/uart_init.c" 3 4
                 ((void *)0)
# 150 "../UART/uart_init.c"
                 : (uart_num==2?
# 150 "../UART/uart_init.c" 3 4
                 ((void *)0)
# 150 "../UART/uart_init.c"
...
# 150 "../UART/uart_init.c" 3 4
                                    ((void *)0)
# 150 "../UART/uart_init.c"
                                    ))), 1, (uart_num==0?16: (uart_num==1?16: (uart_num==2?16: 16))));
  RingBuffer_Init((uart_num==0?&txring0: (uart_num==1?
# 151 "../UART/uart_init.c" 3 4
                 ((void *)0)
# 151 "../UART/uart_init.c"
                 : (uart_num==2?
# 151 "../UART/uart_init.c" 3 4
                 ((void *)0)
# 151 "../UART/uart_init.c"
...
# 151 "../UART/uart_init.c"
  ...
  Chip_UART_IntEnable((uart_num==0?((LPC_USART_T *) 0x4000C000): (uart_num==1?((LPC_USART_T *) 0x40010000): (uart_num==2?((LPC_USART_T *) 0x40098000): ((LPC_USART_T *) 0x4009C000)))), ((1 << 0) | (1 << 2)));


  NVIC_SetPriority((uart_num==0?UART0_IRQn: (uart_num==1?UART1_IRQn: (uart_num==2?UART2_IRQn: UART3_IRQn))), 1);
  NVIC_EnableIRQ((uart_num==0?UART0_IRQn: (uart_num==1?UART1_IRQn: (uart_num==2?UART2_IRQn: UART3_IRQn))));

  const char Uart_init_msg[] = "\r\nHola mundo:\r\n";


  Chip_UART_SendRB((uart_num==0?((LPC_USART_T *) 0x4000C000): (uart_num==1?((LPC_USART_T *) 0x40010000): (uart_num==2?((LPC_USART_T *) 0x40098000): ((LPC_USART_T *) 0x4009C000)))), (uart_num==0?&txring0: (uart_num==1?
# 163 "../UART/uart_init.c" 3 4
                                      ((void *)0)
# 163 "../UART/uart_init.c"
                                      : (uart_num==2?
# 163 "../UART/uart_init.c" 3 4
                                      ((void *)0)
# 163 "../UART/uart_init.c"
...
# 163 "../UART/uart_init.c" 3 4
                                      ((void *)0)
# 163 "../UART/uart_init.c"
                                      ))), Uart_init_msg, sizeof(Uart_init_msg));
 }
