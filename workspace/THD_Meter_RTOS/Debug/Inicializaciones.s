...
.L24:
	...
	.word	.LC1
	.word	.LC2
	.word	fft_inst_q31_complex.10154
	.word	fft_inst_q31
	.word	ifft_inst_q31
	.word	.LC3
	.word	.LC4
...
.L47:
	...
	nop
.L38:
	.loc 5 157 0 discriminator 2
	ldr	r3, [r7, #52]
	subs	r3, r3, #1
	str	r3, [r7, #52]
.L36:
	.loc 5 157 0 is_stmt 0 discriminator 1
	ldr	r3, [r7, #52]
	cmp	r3, #0
	bne	.L43
.L42:
...
.L52:
	...
	cmp	r3, #1
	bne	.L54
	.loc 5 220 0 is_stmt 0 discriminator 1
	movs	r3, #4
	b	.L55
.L54:
	.loc 5 220 0 discriminator 2
	movs	r3, #0
.L55:
	...
	orrs	r3, r3, r2
	str	r3, [r7, #20]
	.loc 5 222 0 is_stmt 1 discriminator 4
	ldr	r3, [r7]
	ldrb	r3, [r3, #5]	@ zero_extendqisi2
	subs	r3, r3, #1
	lsls	r3, r3, #6
	...
	orrs	r3, r3, r2
	str	r3, [r7, #20]
	.loc 5 223 0 discriminator 4
	ldr	r3, [r7, #4]
	ldr	r2, [r7, #20]
	str	r2, [r3]
	.loc 5 225 0 discriminator 4
	ldr	r3, [r7, #4]
	movs	r2, #8
	str	r2, [r3, #48]
	...
	ldr	r3, [r7, #4]
	str	r2, [r3, #32]
	.loc 5 235 0 discriminator 4
	movs	r3, #1
.L56:
	.loc 5 236 0 discriminator 1
	mov	r0, r3
	adds	r7, r7, #24
	.cfi_def_cfa_offset 8
	mov	sp, r7
...
.L61:
	...
	cmp	r3, #1
	bne	.L63
	.loc 5 263 0 is_stmt 0 discriminator 1
	movs	r3, #4
	b	.L64
.L63:
	.loc 5 263 0 discriminator 2
	movs	r3, #0
.L64:
	...
	orrs	r3, r3, r2
	str	r3, [r7, #20]
	.loc 5 265 0 is_stmt 1 discriminator 4
	ldr	r3, [r7]
	ldrb	r3, [r3, #5]	@ zero_extendqisi2
	subs	r3, r3, #1
	lsls	r3, r3, #6
	...
	orrs	r3, r3, r2
	str	r3, [r7, #20]
	.loc 5 266 0 discriminator 4
	ldr	r3, [r7, #4]
	ldr	r2, [r7, #20]
	str	r2, [r3, #4]
	.loc 5 268 0 discriminator 4
	ldr	r3, [r7, #4]
	movs	r2, #8
	str	r2, [r3, #52]
...
.LFE376:
	...
	.section	.bss.init_flag.10212,"aw",%nobits
	.type	init_flag.10212, %object
	.size	init_flag.10212, 1
init_flag.10212:
	.space	1
	.section	.bss.fft_inst_q31_complex.10154,"aw",%nobits
	.align	2
	.type	fft_inst_q31_complex.10154, %object
	.size	fft_inst_q31_complex.10154, 16
fft_inst_q31_complex.10154:
	.space	16
	.text
.Letext0:
...
.Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.4byte	fft_inst_q31_complex.10154
	.uleb128 0x22
	.ascii	"st\000"
	.byte	0x4
	.byte	0x1e
