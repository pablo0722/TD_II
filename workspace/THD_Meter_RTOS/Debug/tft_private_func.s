...
.LFE374:
	...
	.section	.text.tft_Delay_priv,"ax",%progbits
	.align	2
	.global	tft_Delay_priv
	.thumb
	.thumb_func
	.type	tft_Delay_priv, %function
tft_Delay_priv:
.LFB379:
	.file 3 "../TFT/tft_private_func.c"
	.loc 3 19 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 1, uses_anonymous_args = 0
	...
	b	.L25
.L26:
	.loc 3 20 0 is_stmt 0 discriminator 2
	ldr	r3, [r7, #4]
	subs	r3, r3, #1
	str	r3, [r7, #4]
.L25:
	...
	.cfi_endproc
.LFE379:
	.size	tft_Delay_priv, .-tft_Delay_priv
	.section	.text.tft_SendCommand_priv,"ax",%progbits
	.align	2
	.global	tft_SendCommand_priv
	.thumb
	.thumb_func
	.type	tft_SendCommand_priv, %function
tft_SendCommand_priv:
.LFB380:
	.loc 3 24 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 8
...
.L28:
	...
	.cfi_endproc
.LFE380:
	.size	tft_SendCommand_priv, .-tft_SendCommand_priv
	.section	.text.tft_SendData_priv,"ax",%progbits
	.align	2
	.global	tft_SendData_priv
	.thumb
	.thumb_func
	.type	tft_SendData_priv, %function
tft_SendData_priv:
.LFB381:
	.loc 3 35 0
	.cfi_startproc
...
.L31:
	...
	.cfi_endproc
.LFE381:
	.size	tft_SendData_priv, .-tft_SendData_priv
	.section	.text.tft_TM_Send,"ax",%progbits
	.align	2
	.thumb
	.thumb_func
	.type	tft_TM_Send, %function
tft_TM_Send:
.LFB382:
	.loc 3 49 0
	.cfi_startproc
...
.Letext0:
	...
	.file 13 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\ADC_DAC/adc_dac_header.h"
...
.LASF2978:
	.ascii	"../TFT/tft_private_func.c\000"
.LASF691:
...
.LASF2955:
	.ascii	"tft_SendCommand_priv\000"
.LASF2408:
