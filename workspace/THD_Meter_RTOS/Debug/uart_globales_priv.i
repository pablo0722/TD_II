...
# 19 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\inc/header.h" 2
 ...
 void main_while();
# 11 "../UART/uart_globales_priv.c" 2
# 1 "../UART/uart_header_priv.h" 1
# 9 "../UART/uart_header_priv.h"
#define UART_HEADER_PRIV_H_ 




#define UART_IN_STATUS_A_LISTO -3
#define UART_IN_STATUS_B_LISTO -2
#define UART_IN_STATUS_NONE -1
#define UART_IN_STATUS_A_LEYENDO 0
#define UART_IN_STATUS_A_LEYENDO_B_LISTO 1
#define UART_IN_STATUS_B_LEYENDO 2
#define UART_IN_STATUS_B_LEYENDO_A_LISTO 3



#define UART_OUT_STATUS_NONE -1
#define UART_OUT_STATUS_A_ESCRIBIENDO 0
#define UART_OUT_STATUS_A_ESCRIBIENDO_B_LISTO 1
#define UART_OUT_STATUS_B_ESCRIBIENDO 2
#define UART_OUT_STATUS_B_ESCRIBIENDO_A_LISTO 3
...
# 12 "../UART/uart_globales_priv.c" 2
...
# 17 "../UART/uart_globales_priv.c" 3 4
                               ((void *)0)
# 17 "../UART/uart_globales_priv.c"
                                   ;
   volatile uint8_t *uart0_in_A = 
# 18 "../UART/uart_globales_priv.c" 3 4
                                 ((void *)0)
# 18 "../UART/uart_globales_priv.c"
                                     ;
   volatile uint8_t *uart0_in_B = 
# 19 "../UART/uart_globales_priv.c" 3 4
                                 ((void *)0)
# 19 "../UART/uart_globales_priv.c"
                                     ;
   volatile uint32_t uart0_in_len = 0;
   volatile uint32_t uart0_in_idx = 0;
   volatile int8_t uart0_in_status = -1;


   volatile uint8_t *uart1_in = 
# 25 "../UART/uart_globales_priv.c" 3 4
                               ((void *)0)
# 25 "../UART/uart_globales_priv.c"
                                   ;
   volatile uint8_t *uart1_in_A = 
# 26 "../UART/uart_globales_priv.c" 3 4
                                 ((void *)0)
# 26 "../UART/uart_globales_priv.c"
                                     ;
   volatile uint8_t *uart1_in_B = 
# 27 "../UART/uart_globales_priv.c" 3 4
                                 ((void *)0)
# 27 "../UART/uart_globales_priv.c"
                                     ;
   volatile uint32_t uart1_in_len = 0;
   volatile uint32_t uart1_in_idx = 0;
   volatile int8_t uart1_in_status = -1;
# 52 "../UART/uart_globales_priv.c"
   const uint8_t * volatile uart0_out = 
# 52 "../UART/uart_globales_priv.c" 3 4
                                       ((void *)0)
# 52 "../UART/uart_globales_priv.c"
                                           ;
   const uint8_t * volatile uart0_out_A = 
# 53 "../UART/uart_globales_priv.c" 3 4
                                         ((void *)0)
# 53 "../UART/uart_globales_priv.c"
                                             ;
   const uint8_t * volatile uart0_out_B = 
# 54 "../UART/uart_globales_priv.c" 3 4
                                         ((void *)0)
# 54 "../UART/uart_globales_priv.c"
                                             ;
   ...
   volatile int8_t uart0_out_status = -1;


   const uint8_t * volatile uart1_out = 
# 62 "../UART/uart_globales_priv.c" 3 4
                                       ((void *)0)
# 62 "../UART/uart_globales_priv.c"
                                           ;
   const uint8_t * volatile uart1_out_A = 
# 63 "../UART/uart_globales_priv.c" 3 4
                                         ((void *)0)
# 63 "../UART/uart_globales_priv.c"
                                             ;
   const uint8_t * volatile uart1_out_B = 
# 64 "../UART/uart_globales_priv.c" 3 4
                                         ((void *)0)
# 64 "../UART/uart_globales_priv.c"
                                             ;
   ...
   volatile int8_t uart1_out_status = -1;
