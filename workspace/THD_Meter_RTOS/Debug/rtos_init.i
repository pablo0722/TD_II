...
# 11 "../RTOS/rtos_init.c" 2
 ...
 void task_init()
 {
  ...
  Chip_GPIO_SetDir(((LPC_GPIO_T *) 0x2009C000), 0, 0, 0);
   ...
   { ( sem_adc_pre ) = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) ); if( ( sem_adc_pre ) != 
# 30 "../RTOS/rtos_init.c" 3 4
  ((void *)0) 
# 30 "../RTOS/rtos_init.c"
  ) { ( void ) xQueueGenericSend( ( QueueHandle_t ) ( ( sem_adc_pre ) ), 
# 30 "../RTOS/rtos_init.c" 3 4
  ((void *)0)
# 30 "../RTOS/rtos_init.c"
  , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ); } };
   { ( sem_adc_proc ) = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) ); if( ( sem_adc_proc ) != 
# 31 "../RTOS/rtos_init.c" 3 4
  ((void *)0) 
# 31 "../RTOS/rtos_init.c"
...
# 31 "../RTOS/rtos_init.c"
  , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ); } };
   { ( sem_adc_post ) = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) ); if( ( sem_adc_post ) != 
# 32 "../RTOS/rtos_init.c" 3 4
  ((void *)0) 
# 32 "../RTOS/rtos_init.c"
  ) { ( void ) xQueueGenericSend( ( QueueHandle_t ) ( ( sem_adc_post ) ), 
# 32 "../RTOS/rtos_init.c" 3 4
  ((void *)0)
# 32 "../RTOS/rtos_init.c"
  , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ); } };
