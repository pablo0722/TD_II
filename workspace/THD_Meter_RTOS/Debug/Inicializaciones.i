...
# 19 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\inc/header.h" 2
 ...
 void main_while();
# 10 "../src/Inicializaciones.c" 2


static inline void main_gpio_init()
{

 Chip_IOCON_PinMux (((LPC_IOCON_T *) 0x4002C000), 0, 0, (0x2), 0x0 );
 Chip_GPIO_SetDir(((LPC_GPIO_T *) 0x2009C000), 0, 0, 0);
 Chip_IOCON_PinMux (((LPC_IOCON_T *) 0x4002C000), 0, 0, (0x2), 0x0 );
 Chip_GPIO_SetDir(((LPC_GPIO_T *) 0x2009C000), 0, 0, 0);
 Chip_IOCON_PinMux (((LPC_IOCON_T *) 0x4002C000), 0, 0, (0x2), 0x0 );
 Chip_GPIO_SetDir(((LPC_GPIO_T *) 0x2009C000), 0, 0, 0);
