...
# 58 "../RTOS/rtos_tareas.c"
 void vTask_main(void *pvParameters)
 {
  while(1)
  {
   xQueueGenericReceive( ( QueueHandle_t ) ( sem_timer0_match1 ), 
# 62 "../RTOS/rtos_tareas.c" 3 4
  ((void *)0)
# 62 "../RTOS/rtos_tareas.c"
  , ( 0 ), ( ( BaseType_t ) 0 ) );

   if(Chip_GPIO_GetPinState(((LPC_GPIO_T *) 0x2009C000), 0, 0))
   {
    flag_use_dac = TRUE;
    flag_do_thd = FALSE;
    flag_do_rem = FALSE;
 ...
 void vTask_THD( void *pvParameters )
 {
  q31_t num = 0;
  uint32_t i;
  q31_t fft_dep[2048/2];

  while(1)
  {
   xQueueGenericReceive( ( QueueHandle_t ) ( sem_adc_proc ), 
# 93 "../RTOS/rtos_tareas.c" 3 4
  ((void *)0)
# 93 "../RTOS/rtos_tareas.c"
  , ( 0 ), ( ( BaseType_t ) 0 ) );
   ...
   arm_min_q31(fft_dep, 2048/2, &fft_min, &fft_max_idx);


   arm_max_q31(fft_dep, 2048/2, &fft_max, &fft_max_idx);
