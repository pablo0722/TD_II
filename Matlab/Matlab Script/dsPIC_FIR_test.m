...
%% Señal de prueba
A = 0.5; f0 = 2000;N = 256;fs = 48000;ph = 0;NBits = 16;d=0.5;   
...
%Hd=My_filter;                                                   % Objeto filtro diseñado con FDATool
Hd=BandPass;
...
fid = fopen('./Archivos Import Export/dump_fir_test.mch');               % Abro el archivo de texto exportado por MPLABX
