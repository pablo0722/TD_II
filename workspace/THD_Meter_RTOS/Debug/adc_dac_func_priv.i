...
# 12 "../ADC_DAC/private/adc_dac_func_priv.c" 2
 ...
 void adc_ext_pre_procesamiento()
 {
  if(((dma_adc_ext_status & 0x06) == 0x02))
  {
   ...
   for(int i=0; i<2048; i++)
   {
    ...
    xQueueGenericSend( ( QueueHandle_t ) ( sem_adc_ext_proc ), 
# 37 "../ADC_DAC/private/adc_dac_func_priv.c" 3 4
   ((void *)0)
# 37 "../ADC_DAC/private/adc_dac_func_priv.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
