...
static inline uint16_t dac_int_set_data(uint32_t data)
{
 ...
 void main_adc_post()
 {
  ...
  dma_adc_ext_memory = 
# 98 "../ADC_DAC/adc_dac_main.c" 3 4
                      ((void *)0)
# 98 "../ADC_DAC/adc_dac_main.c"
                          ;
  dma_adc_ext_descriptor = 
# 99 "../ADC_DAC/adc_dac_main.c" 3 4
                          ((void *)0)
# 99 "../ADC_DAC/adc_dac_main.c"
                              ;
