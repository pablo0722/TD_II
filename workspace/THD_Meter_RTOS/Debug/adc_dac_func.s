...
.LBB2:
	...
	b	.L43
.L44:
	.loc 2 180 0 is_stmt 0 discriminator 3
	ldr	r3, [r7, #4]
	adds	r3, r3, #1
	str	r3, [r7, #4]
.L43:
...
.LBB3:
	...
	b	.L53
.L54:
	.loc 2 217 0 is_stmt 0 discriminator 3
	ldr	r3, [r7, #4]
	adds	r3, r3, #1
	str	r3, [r7, #4]
.L53:
	.loc 2 217 0 discriminator 1
	ldr	r3, [r7, #4]
	cmp	r3, #2048
	blt	.L54
.LBE3:
...
.Letext0:
	...
	.file 15 "../ADC_DAC/private/adc_dac_header_priv.h"
