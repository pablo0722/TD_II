...
void TIMER0_IRQHandler(void)
{
 ...
 if (Chip_TIMER_MatchPending(((LPC_TIMER_T *) 0x40004000), channel_1))
 {
  Chip_TIMER_ClearMatch(((LPC_TIMER_T *) 0x40004000), channel_1);

  xQueueGiveFromISR( ( QueueHandle_t ) ( sem_timer0_match1 ), ( &xHigherPriorityTaskWoken ) );
# 36 "../TIMER/timer_irq.c"
...
void TIMER1_IRQHandler( void )
{
 ...
 if( Chip_TIMER_MatchPending(((LPC_TIMER_T *) 0x40008000), channel_0) )
 {
  Chip_TIMER_ClearMatch(((LPC_TIMER_T *) 0x40008000), channel_0);

  xQueueGiveFromISR( ( QueueHandle_t ) ( sem_timer1_match0 ), ( &xHigherPriorityTaskWoken ) );
  if( xHigherPriorityTaskWoken ) ( * ( ( volatile uint32_t * ) 0xe000ed04 ) ) = ( 1UL << 28UL );
 }
 if( Chip_TIMER_MatchPending(((LPC_TIMER_T *) 0x40008000), channel_1) )
 {
  Chip_TIMER_ClearMatch(((LPC_TIMER_T *) 0x40008000), channel_1);

  xQueueGiveFromISR( ( QueueHandle_t ) ( sem_timer1_match1 ), ( &xHigherPriorityTaskWoken ) );
  if( xHigherPriorityTaskWoken ) ( * ( ( volatile uint32_t * ) 0xe000ed04 ) ) = ( 1UL << 28UL );
 }
}
