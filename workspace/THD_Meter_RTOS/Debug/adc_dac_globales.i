...
# 19 "D:\\UTN\\Git\\TD_II\\TD_II\\workspace\\THD_Meter_RTOS\\inc/header.h" 2
 ...
 void main_while();
# 11 "../ADC_DAC/adc_dac_globales.c" 2




 DMA_TransferDescriptor_t *dma_adc_ext_descriptor = 
# 15 "../ADC_DAC/adc_dac_globales.c" 3 4
                                                   ((void *)0)
# 15 "../ADC_DAC/adc_dac_globales.c"
                                                       ;
 DMA_TransferDescriptor_t dma_adc_ext_descriptor_A;
 DMA_TransferDescriptor_t dma_adc_ext_descriptor_B;

 volatile uint32_t *dma_adc_ext_memory = 
# 19 "../ADC_DAC/adc_dac_globales.c" 3 4
                                        ((void *)0)
# 19 "../ADC_DAC/adc_dac_globales.c"
                                            ;

 volatile uint32_t dma_adc_ext_memory_A[2048]
            __attribute__ ((section (".bss.$RamAHB32")));

 volatile uint32_t dma_adc_ext_memory_B[2048]
            __attribute__ ((section (".bss.$RamAHB32")));

 uint8_t dma_adc_ext_canal;

 volatile uint8_t dma_adc_ext_status = -1;


  SemaphoreHandle_t sem_adc_proc;
 ...
 volatile uint16_t dma_dac_int_memory_A[2048]
            __attribute__ ((section (".bss.$RamAHB32")));
 volatile uint16_t dma_dac_int_memory_B[2048]
            __attribute__ ((section (".bss.$RamAHB32")));

 uint8_t dma_dac_int_canal;

 volatile uint8_t dma_dac_int_status = -1;
