...
static void tft_gpio_init_priv()
{
 pin_gpio_init(2,7, (0x2 << 2), 1);
 pin_gpio_init(1,29, (0x2 << 2), 1);
 pin_gpio_init(4,28, (0x2 << 2), 1);
 pin_gpio_init(1,23, (0x2 << 2), 1);
 pin_gpio_init(1,20, (0x2 << 2), 1);
 pin_gpio_init(0,19, (0x2 << 2), 1);
 pin_gpio_init(3,26, (0x2 << 2), 1);
 pin_gpio_init(1,25, (0x2 << 2), 1);
 pin_gpio_init(1,22, (0x2 << 2), 1);
 pin_gpio_init(1,19, (0x2 << 2), 1);
 pin_gpio_init(0,20, (0x2 << 2), 1);
 pin_gpio_init(3,25, (0x2 << 2), 1);
 pin_gpio_init(2,6, (0x2 << 2), 1);
 pin_gpio_init(1,24, (0x2 << 2), 1);
 pin_gpio_init(1,21, (0x2 << 2), 1);
 pin_gpio_init(1,18, (0x2 << 2), 1);
 pin_gpio_init(0,9, (0x2 << 2), 1);
    pin_gpio_init(0,8, (0x2 << 2), 1);
    pin_gpio_init(0,7, (0x2 << 2), 1);
    pin_gpio_init(0,6, (0x2 << 2), 1);
    pin_gpio_init(2,5, (0x2 << 2), 1);
    pin_gpio_init(2,4, (0x2 << 2), 1);
